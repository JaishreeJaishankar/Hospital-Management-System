...
class Patientrec {
  String pname,pgender,pbloodgroup,pphonenumber;
  int page,spid,pid,count=0;
  public int q[]=new int[100];
    ...
    public void pim() throws IOException {
        int a,k,x,i=0;
        boolean flag1=true,flag3=false;
while(flag1)
    { 
...
class Doctorrec {
   ...
   String dname,dgender,dspecial,dphonenumber;
   int dage,sdid,did,count=0;
...
public class Hospital {
    public static void main(String[] args) throws IOException {
     ...
     final int LIMIT = 3; 
int count = 0; 
String username1 = "oopsproject"; 
String password1 = "batch1"; 
